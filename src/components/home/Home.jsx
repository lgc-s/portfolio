                ...
                <Background height="86vh" bg="ImgHome">
                    <Box>
                        ...
                        <div className="Home">
                            ...
                            <h2>Professional and ambitious, believes in quality and aesthetic as fundamentals of Front-End Development.</h2>
                            <div>
                ...
                <Background height="86vh" bg="ImgHome">
                    <Box>
                        ...
                        <div className="Home">
                            ...
                            <h2>Profissional e ambicioso, acredita em qualidade e estética como fundamentos do Desenvolvimento Front-End.</h2>
                            <div>
